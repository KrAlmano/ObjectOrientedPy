...
class VehicleRent:
    ...
    def rentHourly(self,n):
        ...
        if n<=0:
            ...
            print("Renter a {} vehicle for hourly at {} hours".format(n,self.now.hour))
        ...
        if brand == "car":
            if rentalTime and rentalBasis and numOfVehicle:
                ...
                if rentalBasis == 1 : #Hourly
                    bill = rentalPeriod.total_seconds()/3600*car_h_price*numOfVehicle
...
class Customer:
    ...
    def requestVehicle(self,brand):
        ...
        """
            take a request vehicle from customer
        """
        if brand =="bike":
